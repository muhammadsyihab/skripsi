...
class NotifikasiOperatorWidget extends StatefulWidget {
  const NotifikasiOperatorWidget({Key? key}) : super(key: key);

  @override
  _NotifikasiOperatorWidgetState createState() =>
      _NotifikasiOperatorWidgetState();
}

class _NotifikasiOperatorWidgetState extends State<NotifikasiOperatorWidget> {
